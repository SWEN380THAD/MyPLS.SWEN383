...
INSERT INTO `courses` VALUES (1,'This course gives you a very basic introdcution to the Java programinglanguage.  we will cover everything from seting up your computer to deploying an application.','access to pc or MAC','No prereqs needed','Introduction to Java'),(9,'this course will cover the basics of creating your first Python application.  from setting up your computer, writing the code and on to implementing your application.','access to computer and internet','java and javascript','Python');
...
CREATE TABLE `group_users` (
  ...
  `status` enum('0','1') DEFAULT '1',
  `type` varchar(45) DEFAULT '"Public"',
...
-- Dump completed on 2021-03-17 15:07:59
