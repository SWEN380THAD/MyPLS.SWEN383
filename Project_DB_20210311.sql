...
INSERT INTO `courses` VALUES (1,'learning java','access to pc','none'),(2,'learning Java Script','access to PC','java course');
...
CREATE TABLE `user_courses` (
  ...
  CONSTRAINT `fk_course_user_id` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`),
...
INSERT INTO `user_courses` VALUES (3,1),(4,2);
...
-- Dump completed on 2021-03-11  8:31:12
